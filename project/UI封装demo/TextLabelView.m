...
@interface TextLabelView ()<UITextFieldDelegate>
...
- (instancetype)init {
    self = [super init];
    if (self) {
        self = [[[NSBundle mainBundle] loadNibNamed:@"TextLabelView" owner:self options:nil] lastObject];
        // 初始化设置
...
- (void)show {
    ...
    [UIView animateWithDuration:0.35 delay:0 usingSpringWithDamping:0.75 initialSpringVelocity:1 options:UIViewAnimationOptionCurveEaseInOut animations:^{
...
/** 隐藏 */
- (void)hide {
    [UIView animateWithDuration:0.35 delay:0 usingSpringWithDamping:0.75 initialSpringVelocity:1 options:0 animations:^{
        CGPoint center = self.center;
