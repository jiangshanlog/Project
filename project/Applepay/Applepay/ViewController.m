...
- (IBAction)btnclick:(id)sender {
    ...
    payRequest.merchantIdentifier = @"merchant.Johnson.Apple-Pay-test";  //申请的merchantID
    ...
    NSDecimalNumber *discountAmount = [NSDecimalNumber decimalNumberWithString:@"-11"];      //-12.74
    ...
    PKPaymentSummaryItem *total = [PKPaymentSummaryItem summaryItemWithLabel:@"Johnson" amount:totalAmount];  //最后这个是支付给谁。哈哈，快支付给我
