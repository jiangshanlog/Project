...
- (IBAction)onLocalButton:(id)sender {
    NSString* url = @"http://10962.hlsplay.aodianyun.com/eggvr/stream.m3u8";
    [self launchAsVideo:[NSURL URLWithString:url]];
//    NSString *path = [[NSBundle mainBundle] pathForResource:@"865ce98285de7ca872d6740ae08c03bf.m3u8" ofType:@"mp4"];
